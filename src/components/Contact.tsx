            ...
            <div className="glass overflow-hidden border-primary/20 bg-primary/[0.02]">
                <div className="p-12 md:p-24 flex flex-col md:flex-row items-center gap-16">
                    <div className="flex-1 reveal">
                        ...
                        <p className="text-muted max-w-md text-lg font-archivo">
                    ...
                    <div className="flex-none reveal">
                        <div className="flex flex-col gap-4">
                            <a href="mailto:hello@kanydev.ai" className="btn-brutal text-2xl lowercase font-archivo group">
                                hello@<span className="text-black group-hover:italic transition-all">kanydev.ai</span>
                            </a>

                            <div className="flex gap-4 mt-6">
                                <a href="#" aria-label="Site web" className="p-4 glass hover:bg-white/10 transition-colors"><Globe size={24} /></a>
                                <a href="#" aria-label="Réseaux sociaux" className="p-4 glass hover:bg-white/10 transition-colors"><Cpu size={24} /></a>
                                <a href="mailto:hello@kanydev.ai" aria-label="Envoyer un email" className="p-4 glass hover:bg-white/10 transition-colors"><Mail size={24} /></a>
                            </div>
                        </div>
                    </div>
                </div>
