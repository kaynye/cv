...
const Projects: React.FC = () => {
    ...
    useEffect(() => {
        // Only pin on desktop and when motion is allowed
    ...
    return (
        <>
            ...
            <section className="block md:hidden py-20">
                <div className="mb-12 reveal">
                    <span className="text-primary font-space tracking-[.5em] text-xs mb-4 block underline underline-offset-8">CASE STUDIES</span>
                    <h2 className="text-5xl tracking-tighter leading-none mb-6 text-main">
                        PROJETS<br /><span className="text-primary italic">SÉLECTIONNÉS</span>
                    </h2>
                    <p className="text-lg text-text-muted font-light leading-relaxed">
                        Une exploration de nos dernières transmissions Neurales.
                    </p>
                </div>
                <div className="space-y-6">
                    {projects.map((project, index) => (
                        <div key={index} className="glass-card overflow-hidden reveal">
                            ...
                            <div className="p-6">
                                <span className="text-primary font-space tracking-widest text-xs uppercase block mb-2">
                                    {project.category}
                                </span>
                                <h3 className="text-2xl tracking-tight text-main mb-4">{project.title}</h3>
                                <Link
                                    to={project.link}
                                    className="btn-brutal !px-6 !py-3 text-xs flex items-center gap-2 w-fit"
                                >
